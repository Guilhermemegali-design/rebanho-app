...
const TABELA_POR_STORE = {
  ...
  protocolo_animais: "rebanho_protocolo_animais",
  diagnosticos_gestacao: "rebanho_diagnosticos_gestacao",
  partos: "rebanho_partos",
  desmames: "rebanho_desmames",
};
...
const TABELAS_OPERACIONAIS = new Set([
  ...
  "rebanho_touros",
  "rebanho_protocolos_iatf",
  "rebanho_periodos_repasse",
]);
