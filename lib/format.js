...
// retornando outra data ISO. Usado pra calcular datas previstas
// (D8/D11 do protocolo IATF, parto previsto, desmame previsto) sem
// nunca persistir o resultado — sempre derivado na hora.
export function somarDias(dataIso, n) {
  if (!dataIso || n == null) return null;
