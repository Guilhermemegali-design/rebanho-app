...
const STORES_CACHE = [
  ...
  "touros", "protocolos_iatf", "periodos_repasse",
  "protocolo_animais_cache", "diagnosticos_gestacao_cache", "partos_cache", "desmames_cache",
];
const STORES_PENDENTES = [
  "pesagens", "movimentacoes", "procedimentos", "abastecimentos",
  "protocolo_animais", "diagnosticos_gestacao", "partos", "desmames",
];
